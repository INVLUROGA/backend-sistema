...
const terminologiasPorEntidad = async(req = request , res = response )=>{
    ...
    try {
        ...
        parametros.map((parametro)=>{
            ...
            let parametrosPorEntidadFiltrado = response.parametros.filter(parametoFiltrado => parametoFiltrado.entidad_param == parametro.entidad_param);
        ...
        parametrosGasto.map((parametro)=>{
            ...
            const parametroGasto = response.parametrosGasto.filter((parametoFiltrado)=> parametoFiltrado.empresa == parametro.id_empresa);
